...
wolframscript -f phase1.wls > phase1.log &
wolframscript -f phase2.wls > phase2.log &
wolframscript -f phase3.wls > phase3.log &
wolframscript -f phase4.wls > phase4.log &
wolframscript -f phase5.wls > phase5.log &
wait
wolframscript -f phase6.wls > phase6.log &
wolframscript -f phase7.wls > phase7.log &
...
wait
wolframscript -f phase14.wls > phase14.log &
wolframscript -f phase15.wls > phase15.log &
wolframscript -f phase16.wls > phase16.log &
...
wolframscript -f phase23.wls > phase23.log &
wolframscript -f phase24.wls > phase24.log &
wolframscript -f phase25.wls > phase25.log &
wait
...
wolframscript -f phase32.wls > phase32.log &
wolframscript -f phase33.wls > phase33.log &
wait
wait
